        ...
        <Card className="p-4">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input value={form.phuongCu} onChange={(e) => setForm((f) => ({ ...f, phuongCu: e.target.value }))} placeholder="VD: Đại Lộc" />
            </div>
            <div className="space-y-1">
              <Label className="text-xs">Phường mới *</Label>
              <Input value={form.phuongMoi} onChange={(e) => setForm((f) => ({ ...f, phuongMoi: e.target.value }))} placeholder="VD: Xã Đại Lộc" required />
            </div>
            <div className="space-y-1">
